...
if submit_button:
    ...
    input_data = pd.DataFrame({
        ...
        'BUN': [bun],
        'CCR': [ccr],
        'FPG of final visit': [fpg_final],
        'Diabetes diagnosed during follow-up': [diabetes_map[diabetes_during_followup]],
        'Censor of diabetes at follow-up': [0],
        'Year of follow-up': [5],
        'Smoking status': [smoking_map[smoking_status]],
        'Drinking status': [drinking_map[drinking_status]],
        'Family history of diabetes': [family_map[family_history_diabetes]],
        'Atrial Fibrillation': [af_map[af]],
        'TyG Index': [tyg_index],
    })
